...
- [Python smart contracts](https://github.com/CityOfZion/awesome-neo/blob/master/resources/python-examples.md) - Examples of smart contracts written in Python, from the Neo Python core team and DApp competition entrants.
